...
| [`agents/`](agents/) | Build-free Agentfiles for `microagent dispatch`: OpenAI Agents SDK and Claude agents run one-shot with a host-side credential swap - the guest never holds the API key. | [`agents/README.md`](agents/README.md) |
