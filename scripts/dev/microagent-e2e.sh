...
Scenarios:
  ...
  model-mediation-pressure-ci
                    ...
                    experimental run --model mediator through the fake custom
                    runner. Uses required gates and emits pressure-decision.*.
