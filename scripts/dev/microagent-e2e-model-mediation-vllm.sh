...
PRESSURE_WORKSPACES="${MICROAGENT_E2E_MODEL_MEDIATION_VLLM_PRESSURE_WORKSPACES:-2}"
PRESSURE_CONCURRENCY="${MICROAGENT_E2E_MODEL_MEDIATION_VLLM_PRESSURE_CONCURRENCY:-1,2}"
PRESSURE_CASES="${MICROAGENT_E2E_MODEL_MEDIATION_VLLM_PRESSURE_CASES:-direct,local,pf,pa}"
PRESSURE_WARMUPS="${MICROAGENT_E2E_MODEL_MEDIATION_VLLM_PRESSURE_WARMUPS:-1}"
PRESSURE_GATE_MODE="${MICROAGENT_E2E_MODEL_MEDIATION_VLLM_PRESSURE_GATE_MODE:-warn}"
PRESSURE_TELEMETRY="${MICROAGENT_E2E_MODEL_MEDIATION_VLLM_PRESSURE_TELEMETRY:-$TELEMETRY}"
