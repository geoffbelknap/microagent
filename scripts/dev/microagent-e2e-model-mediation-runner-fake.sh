...
OUT_DIR="${MICROAGENT_E2E_MODEL_MEDIATION_RUNNER_FAKE_OUT_DIR:-/tmp/ma-e2e-mm-runner-fake-$(date +%Y%m%d%H%M%S)}"
...
PRESSURE_WORKSPACES="${MICROAGENT_E2E_MODEL_MEDIATION_RUNNER_FAKE_PRESSURE_WORKSPACES:-2}"
PRESSURE_CONCURRENCY="${MICROAGENT_E2E_MODEL_MEDIATION_RUNNER_FAKE_PRESSURE_CONCURRENCY:-1,2}"
PRESSURE_CASES="${MICROAGENT_E2E_MODEL_MEDIATION_RUNNER_FAKE_PRESSURE_CASES:-direct,local,pf,pa}"
PRESSURE_WARMUPS="${MICROAGENT_E2E_MODEL_MEDIATION_RUNNER_FAKE_PRESSURE_WARMUPS:-1}"
PRESSURE_GATE_MODE="${MICROAGENT_E2E_MODEL_MEDIATION_RUNNER_FAKE_PRESSURE_GATE_MODE:-warn}"
PRESSURE_TELEMETRY="${MICROAGENT_E2E_MODEL_MEDIATION_RUNNER_FAKE_PRESSURE_TELEMETRY:-$TELEMETRY}"
MAX_MODELS_TOTAL_P95_DELTA_MS="${MICROAGENT_E2E_MODEL_MEDIATION_RUNNER_FAKE_MAX_MODELS_TOTAL_P95_DELTA_MS:-100}"
MAX_CHAT_TOTAL_P95_DELTA_MS="${MICROAGENT_E2E_MODEL_MEDIATION_RUNNER_FAKE_MAX_CHAT_TOTAL_P95_DELTA_MS:-500}"
MAX_STREAM_TTFB_P95_DELTA_MS="${MICROAGENT_E2E_MODEL_MEDIATION_RUNNER_FAKE_MAX_STREAM_TTFB_P95_DELTA_MS:-250}"
MAX_DECISION_P95_MS="${MICROAGENT_E2E_MODEL_MEDIATION_RUNNER_FAKE_MAX_DECISION_P95_MS:-100}"
...
case "$PRESSURE" in
  1|true|TRUE|yes|YES|required)
    MICROAGENT_E2E_MODEL_MEDIATION_PRESSURE=1 \
      ...
      MICROAGENT_E2E_MODEL_MEDIATION_PRESSURE_SAMPLES="$SAMPLES" \
      MICROAGENT_E2E_MODEL_MEDIATION_PRESSURE_WARMUPS="$PRESSURE_WARMUPS" \
      MICROAGENT_E2E_MODEL_MEDIATION_PRESSURE_CHAT_TOKENS="$CHAT_TOKENS" \
      MICROAGENT_E2E_MODEL_MEDIATION_PRESSURE_STREAM_TOKENS="$STREAM_TOKENS" \
