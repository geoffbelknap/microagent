...
required_features = {
    ...
    "status/inspect/ps": ["status", "inspect", "ps"],
    "result/logs/artifacts": ["result", "logs", "artifacts"],
    "events/stats": ["events", "stats"],
    "connect": ["connect"],
    "exec": ["exec"],
    "halt/quarantine/stop/kill/delete/rm": ["halt", "quarantine", "stop", "kill", "delete", "rm"],
    "clone/cp": ["clone", "cp"],
    "apply": ["apply"],
    "network inspect/modes/publish": ["network"],
    "network create/ls/rm named": ["network"],
    "volume create/ls/inspect/rm": ["volume"],
    "commit/images/prune": ["commit", "images", "prune"],
    "registry auth": [],
