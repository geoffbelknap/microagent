...
DEFAULT_GO_SYMBOL_ALLOWLIST = {
    ...
    "vmkit": {
        ...
        "ContractParity",
        "ContractState",
        # Egress capture-provider reporting (draft; documented in Notion, not the
        # public Go reference yet — see the Egress Capture Provider Contract).
        "EgressBypassHostEnforced",
        "EgressCaptureReport",
        "EgressClassMediate",
        "EgressCoverage",
        ...
        "EgressProtocolCoverage",
        "EgressProviderNone",
        "EgressProviderStatus",
        "EgressProviderSupported",
        "HostSupport",
        "KernelSupport",
        "NegotiateEgressCapture",
        "NormalizeConfig",
        "ReadinessSignal",
        "RuntimeContract",
        "RuntimeReadiness",
