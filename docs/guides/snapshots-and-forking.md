...
copies that resume from it. Snapshots are implemented for Firecracker on Linux
and Apple VF on macOS 14+ hosts where Virtualization.framework save/restore
support validates.
