...
- [Wire up the mediation channel](/recipes/mediation-channel/) — pattern guide for moving the body from one-request-per-restart to a stream of requests over a guest-to-host vsock contract.
