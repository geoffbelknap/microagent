...
|---|---|---|---|---|
| `firecracker` | Linux | Go executable supervisor (`microagent-firecracker-supervisor`) | not supported (use `logs`) | Supervisor records VM PID; `stop` sends SIGTERM, `kill` sends SIGKILL |
