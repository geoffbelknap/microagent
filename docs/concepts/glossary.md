...
- **agent** - the program you run inside a workspace. microagent doesn't define or constrain it; in these docs it means a small LLM loop with tools (see [run your first agent](/getting-started/cli/first-agent/)).
