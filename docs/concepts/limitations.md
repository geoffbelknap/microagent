...
[Coming from Docker: what's intentionally different](../getting-started/coming-from-docker.md#whats-intentionally-different)
...
workspace for file transfer. See [Storage](storage.md) and
[Coming from Docker: no bind mounts](../getting-started/coming-from-docker.md#no-bind-mounts).
...
See [Coming from Docker: no --privileged](../getting-started/coming-from-docker.md#no---privileged).
...
your own tooling. See [`microagent run`](../cli/run.md#container-style-aliases).
...
[Host requirements: macOS](backends.md#macos).
...
[Storage: named volumes](storage.md#named-volumes).
...
to its rootfs, [`microagent commit`](../cli/commit.md) snapshots a stopped
workspace back into an OCI image. See
[Coming from Docker: no build command](../getting-started/coming-from-docker.md#no-build-command).

## See also

- [FAQ](../getting-started/faq.md) - short answers to common questions
- [Boundaries](boundaries.md) - what microagent owns versus what your runtime supplies
- [Coming from Docker](../getting-started/coming-from-docker.md) - the full command map plus what's different
