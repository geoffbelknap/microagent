...
func OperationContracts() []OperationContract {
	operations := []OperationContract{
		...
		{ID: OperationWorkspaceKill, FeatureID: "workspace.lifecycle", CLICommands: []string{"kill"}, MCPTools: []string{"workspace.kill"}, Effect: OperationEffectDestructive, Idempotency: OperationIdempotencyReplayable, Confirmation: OperationConfirmationPreview, SideEffects: workspaceMutationSideEffects()},
		{ID: OperationWorkspaceQuarantine, FeatureID: "workspace.lifecycle", CLICommands: []string{"quarantine"}, MCPTools: []string{"workspace.quarantine"}, Effect: OperationEffectDestructive, Idempotency: OperationIdempotencyReplayable, Confirmation: OperationConfirmationPreview, SideEffects: workspaceMutationSideEffects()},
