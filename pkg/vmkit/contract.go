...
func NewRuntimeContract() RuntimeContract {
	return RuntimeContract{
		...
		Commands: []ContractItem{
			...
			{Name: "start", Description: "start a prepared, halted, stopped, or failed workspace with preserved disk state; a durable containment marker always denies start and restore"},
			...
			{Name: "quarantine", Description: "atomically mark containment, freeze guest execution, sever network, brokers, published ports, and other host authority, capture forensic memory and disk while frozen, then stop into durable custody; capture failure remains frozen and severed for retry"},
		...
		States: []ContractState{
			...
			{Name: StateQuarantined, Description: "freeze, authority severance, and evidence capture completed and the runtime is stopped behind a durable custody marker; disk and event history are preserved", DiskPreserved: true, EventHistoryKept: true},
